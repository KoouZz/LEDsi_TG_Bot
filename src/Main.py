...
class Main:
    ...
    def _register_handlers(self):
        ...
        self.application.add_handler(ApprovalMenu().get_handler_havent_spec())
        self.application.add_handler(ApprovalMenu().get_handler_have_spec())
        self.application.add_handler(StatusMenu().get_handler_status_menu())
        self.application.add_handler(StatusMenu().get_handler_archive())
        self.application.add_handler(StatusMenu().get_handler_back_in_status())
